...
const DailyQuests = () => {
  ...
  return (
    <View>
      {/* <Text className="text-xl font-bold text-black my">Daily Quests</Text> */}
      <View className="flex-row justify-between items-center mb-2 mt-3">
        <Text className="text-xl font-bold text-black">Daily Quests</Text>
        <TouchableOpacity
          className="p-2 border border-black rounded-lg"
          onPress={() => router.push("/completed-quests/daily")}
        >
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          return (
            <View className="py-2 rounded-lg shadow-md mb-1 flex-row items-center">
              <TouchableOpacity
